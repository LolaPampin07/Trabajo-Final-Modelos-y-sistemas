...
%% Gráfico 1: Sistema No Lineal (trayectorias completas)
figure;
...
plot3(xeq2(1), xeq2(2), xeq2(3), 'ks', 'MarkerSize', 8, 'MarkerFaceColor', 'k');
xlabel('x'); ylabel('y'); zlabel('z');
title('Sistema No Lineal - Trayectorias completas');
legend('xi_0','xi_1','xi_2','Xeq1','Xeq2');
grid on; axis tight; view(3);

%% Gráfico 2: Zoom cerca del equilibrio Xeq1
figure;
plot3(X1a_orig(:,1), X1a_orig(:,2), X1a_orig(:,3), 'g--', 'LineWidth', 1.5); hold on;
plot3(X1b_orig(:,1), X1b_orig(:,2), X1b_orig(:,3), 'b--', 'LineWidth', 1.5);
plot3(X1c_orig(:,1), X1c_orig(:,2), X1c_orig(:,3), 'r--', 'LineWidth', 1.5);
plot3(xeq1(1), xeq1(2), xeq1(3), 'ko', 'MarkerSize', 8, 'MarkerFaceColor', 'k');
xlabel('x'); ylabel('y'); zlabel('z');
title('Sistema Linealizado alrededor de Xeq1 (zoom)');
legend('Perturbación xi_0','Perturbación xi_1','Perturbación xi_2','Xeq1');
grid on; axis tight; view(3);
xlim([xeq1(1)-5, xeq1(1)+5]);
ylim([xeq1(2)-5, xeq1(2)+5]);
zlim([xeq1(3)-5, xeq1(3)+5]);

%% Gráfico 3: Zoom cerca del equilibrio Xeq2
figure;
plot3(X2a_orig(:,1), X2a_orig(:,2), X2a_orig(:,3), 'g:', 'LineWidth', 1.5); hold on;
plot3(X2b_orig(:,1), X2b_orig(:,2), X2b_orig(:,3), 'b:', 'LineWidth', 1.5);
plot3(X2c_orig(:,1), X2c_orig(:,2), X2c_orig(:,3), 'r:', 'LineWidth', 1.5);
